...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="mb-3">
                <a href="{{route('tag.create')}}" class="btn-block btn-primary  btn-lg col-2" >{{__('Add new tag')}}</a>
            </div>
            <div class="card col-5">
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap ">
                        ...
                        @if($tags->isEmpty())
                            <tr>
                                <td colspan="3" class="text-center">{{__("No tags")}}</td>
                            </tr>
                        @else
                            @foreach($tags as $tag)
                            <tr>
                                ...
                                <td>
                                    <a class="text-success" href="{{route('tag.edit', $tag->id)}}">
