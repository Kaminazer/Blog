            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{route('user.index')}}" class="small-box-footer">{{__("More info")}} <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="{{route('post.index')}}" class="small-box-footer">{{__("More info")}} <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-primary">
                        ...
                        <a href="{{route('category.index')}}" class="small-box-footer">{{__("More info")}} <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <a href="{{route('tag.index')}}" class="small-box-footer">{{__("More info")}} <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            </div>
