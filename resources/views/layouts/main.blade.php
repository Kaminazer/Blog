        ...
        <header class="edica-header">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{__(route("main.index"))}}"><img src="{{asset('assets/images/logo.svg')}}" alt="Edica"></a>
                    ...
                    <div class="collapse navbar-collapse" id="edicaMainNav">
                        <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                            <li class="nav-item active">
                                <a class="nav-link" href="{{__(route("main.index"))}}">{{__("Home")}} <span class="sr-only">(current)</span></a>
                            </li>
