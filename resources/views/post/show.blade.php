...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{$post->category->title}}</p>
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{__("Written by ")}} {{$post->user->name}} • February 1, 2019• 6:31 pm• Featured • {{$post->comments->count()}} {{__(" comment(s)")}}</p>
            <section class="blog-post-featured-img align-content-center" data-aos="fade-up" data-aos-delay="300">
